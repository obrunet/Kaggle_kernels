...
* Concepts: supervised binary classification, __model explanation__ / feature analysis, __GridsearchCV__. 
...
* Concepts: supervised binary classification (__LightGBM__, __XGBoost__), imbalanced classes, metric: __area under the ROC curve__
...
* Concepts: supervised regression (__GradientBoosting Reg, __Ridge/Lasso__), metric: __RMSLE__
...
* Concepts: __unsupervised__ machine learning (__KMeans Clustering__)
...
* Concepts: supervised binary classification, __classes highly imbalanced__, metric: __Area Under the Precision-Recall Curve__ (AUPRC), __PCA__, Synthetic Minority __Over-sampling__ Technique (SMOTe) & LOF model (LocalOutlierFactor)
...
* Concepts: supervised binary classification, metric: __F1 score, hyperparameters tuning, pipelines__ of models
